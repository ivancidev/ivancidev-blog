...
function ToolCard({ tool }: { tool: (typeof tools)[0] }) {
  return (
    <div className="group rounded-xl border border-[#1f1f1f] hover:border-[#00ff88]/30 bg-[#111]/50 hover:bg-[#111] transition-all duration-200 overflow-hidden">
      {/* Image */}
      {tool.image && (
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <span
            className={`text-xs px-2.5 py-1 rounded-full font-mono ml-auto ${
              tool.status === "live"
